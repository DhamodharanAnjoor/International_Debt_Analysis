# ═══════════════════════════════════════════════════════════════════════════════
# International Debt Analysis — Step 7 : Streamlit Dashboard
# File   : streamlit_dashboard.py
# Run    : streamlit run streamlit_dashboard.py
# Requires: pip install streamlit plotly pandas mysql-connector-python
# Input  : final_merged_debt_data.csv  (generated in Step 2)
# MySQL  : host=localhost, user=root, password=root, db=international_debt_db
# ═══════════════════════════════════════════════════════════════════════════════
...
# ROW 2 — World Map
# ══════════════════════════════════════════════════════════════════════════════
st.markdown('<div class="section-hdr">🗺️ World Map — Total Debt by Country</div>', unsafe_allow_html=True)
map_d = df_filt.groupby(['Country Code','Country Name'])['debt_value'].sum().reset_index()
map_d.columns = ['iso_alpha','Country','Total Debt']
map_d['Billions'] = (map_d['Total Debt']/1e9).round(1)
fm = px.choropleth(map_d, locations='iso_alpha', color='Billions', hover_name='Country',
    hover_data={'Billions':':.1f','iso_alpha':False}, color_continuous_scale='YlOrRd')
fm.update_layout(height=420, margin=dict(t=0,b=0,l=0,r=0),
...
with st.expander("Show / Hide Data Table"):
    ...
    tbl['debt_value'] = tbl['debt_value'].map('{:,.2f}'.format)
...
with st.expander("📖 All 30 Queries — Quick Reference"):
    ref_data = {
        "Query": [f"Q{q['num']:02d}" for q in [{"num": 1}, {"num": 2}, {"num": 3}, {"num": 4}, {"num": 5}, {"num": 6}, {"num": 7}, {"num": 8}, {"num": 9}, {"num": 10}, {"num": 11}, {"num": 12}, {"num": 13}, {"num": 14}, {"num": 15}, {"num": 16}, {"num": 17}, {"num": 18}, {"num": 19}, {"num": 20}, {"num": 21}, {"num": 22}, {"num": 23}, {"num": 24}, {"num": 25}, {"num": 26}, {"num": 27}, {"num": 28}, {"num": 29}, {"num": 30}]],
        "Category": [("Basic" if q["num"]<=10 else "Intermediate" if q["num"]<=20 else "Advanced")
                     for q in [{"num": 1, "title": "Preview debt_data Table", "sql": "SELECT * FROM debt_data LIMIT 10;"}, {"num": 2, "title": "Count Total Records in debt_data", "sql": "SELECT COUNT(*) AS total_records FROM debt_data;"}, {"num": 3, "title": "List All Countries with Region", "sql": "SELECT country_code, country_name, region, income_group\nFROM countries\nWHERE region IS NOT NULL\nORDER BY country_name;"}, {"num": 4, "title": "List All Indicators with Topic", "sql": "SELECT indicator_code, indicator_name, topic\nFROM indicators\nORDER BY topic, indicator_name\nLIMIT 20;"}, {"num": 5, "title": "All Debt Records for India (IND)", "sql": "SELECT d.country_code, c.country_name, i.indicator_name, d.year, d.debt_value\nFROM debt_data d\nJOIN countries  c ON d.country_code   = c.country_code\nJOIN indicators i ON d.indicator_code = i.indicator_code\nWHERE d.country_code = 'IND'\nORDER BY d.year, i.indicator_name\nLIMIT 20;"}, {"num": 6, "title": "All Records for Year 2020", "sql": "SELECT d.country_code, c.country_name, d.indicator_code, d.debt_value\nFROM debt_data d\nJOIN countries c ON d.country_code = c.country_code\nWHERE d.year = 2020\n  AND c.region IS NOT NULL\nORDER BY d.debt_value DESC\nLIMIT 20;"}, {"num": 7, "title": "Records Where debt_value Exceeds 1 Billion", "sql": "SELECT d.country_code, c.country_name, d.indicator_code, d.year, d.debt_value\nFROM debt_data d\nJOIN countries c ON d.country_code = c.country_code\nWHERE d.debt_value > 1000000000\n  AND c.region IS NOT NULL\nORDER BY d.debt_value DESC\nLIMIT 20;"}, {"num": 8, "title": "Count Records per Country", "sql": "SELECT d.country_code, c.country_name, COUNT(*) AS record_count\nFROM debt_data d\nJOIN countries c ON d.country_code = c.country_code\nWHERE c.region IS NOT NULL\nGROUP BY d.country_code, c.country_name\nORDER BY record_count DESC\nLIMIT 15;"}, {"num": 9, "title": "Top 10 Highest Single debt_value Records", "sql": "SELECT d.country_code, c.country_name, i.indicator_name, d.year, d.debt_value\nFROM debt_data d\nJOIN countries  c ON d.country_code   = c.country_code\nJOIN indicators i ON d.indicator_code = i.indicator_code\nWHERE c.region IS NOT NULL\nORDER BY d.debt_value DESC\nLIMIT 10;"}, {"num": 10, "title": "All Countries in South Asia Region", "sql": "SELECT country_code, country_name, income_group, lending_category\nFROM countries\nWHERE region = 'South Asia'\nORDER BY country_name;"}, {"num": 11, "title": "Total Debt per Country (Top 15)", "sql": "SELECT d.country_code, c.country_name,\n       FORMAT(SUM(d.debt_value), 2) AS total_debt_usd\nFROM debt_data d\nJOIN countries c ON d.country_code = c.country_code\nWHERE c.region IS NOT NULL\nGROUP BY d.country_code, c.country_name\nORDER BY SUM(d.debt_value) DESC\nLIMIT 15;"}, {"num": 12, "title": "Total Global Debt per Year", "sql": "SELECT d.year, FORMAT(SUM(d.debt_value), 2) AS global_total_debt\nFROM debt_data d\nJOIN countries c ON d.country_code = c.country_code\nWHERE c.region IS NOT NULL\nGROUP BY d.year\nORDER BY d.year;"}, {"num": 13, "title": "Average and Total Debt by Income Group", "sql": "SELECT c.income_group,\n       COUNT(DISTINCT d.country_code)    AS countries,\n       FORMAT(AVG(d.debt_value), 2)      AS avg_debt,\n       FORMAT(SUM(d.debt_value), 2)      AS total_debt\nFROM debt_data d\nJOIN countries c ON d.country_code = c.country_code\nWHERE c.income_group IS NOT NULL\nGROUP BY c.income_group\nORDER BY SUM(d.debt_value) DESC;"}, {"num": 14, "title": "Total Debt by Region", "sql": "SELECT c.region,\n       COUNT(DISTINCT d.country_code)  AS countries,\n       FORMAT(SUM(d.debt_value), 2)    AS total_debt\nFROM debt_data d\nJOIN countries c ON d.country_code = c.country_code\nWHERE c.region IS NOT NULL\nGROUP BY c.region\nORDER BY SUM(d.debt_value) DESC;"}, {"num": 15, "title": "Countries with Total Debt Above Overall Average", "sql": "SELECT d.country_code, c.country_name,\n       FORMAT(SUM(d.debt_value), 2) AS total_debt\nFROM debt_data d\nJOIN countries c ON d.country_code = c.country_code\nWHERE c.region IS NOT NULL\nGROUP BY d.country_code, c.country_name\nHAVING SUM(d.debt_value) > (\n    SELECT AVG(ctry_sum)\n    FROM (\n        SELECT SUM(d2.debt_value) AS ctry_sum\n        FROM debt_data d2\n        JOIN countries c2 ON d2.country_code = c2.country_code\n        WHERE c2.region IS NOT NULL\n        GROUP BY d2.country_code\n    ) t\n)\nORDER BY SUM(d.debt_value) DESC;"}, {"num": 16, "title": "Top 10 Indicators by Total Debt Value", "sql": "SELECT d.indicator_code,\n       LEFT(i.indicator_name, 55)          AS indicator_name,\n       FORMAT(SUM(d.debt_value), 2)        AS total_debt\nFROM debt_data d\nJOIN indicators i ON d.indicator_code = i.indicator_code\nJOIN countries  c ON d.country_code   = c.country_code\nWHERE c.region IS NOT NULL\nGROUP BY d.indicator_code, i.indicator_name\nORDER BY SUM(d.debt_value) DESC\nLIMIT 10;"}, {"num": 17, "title": "Total Debt by Lending Category", "sql": "SELECT c.lending_category,\n       COUNT(DISTINCT d.country_code)  AS countries,\n       FORMAT(SUM(d.debt_value), 2)    AS total_debt\nFROM debt_data d\nJOIN countries c ON d.country_code = c.country_code\nWHERE c.lending_category IS NOT NULL\nGROUP BY c.lending_category\nORDER BY SUM(d.debt_value) DESC;"}, {"num": 18, "title": "Year-wise Debt Trend for China (CHN)", "sql": "SELECT d.year,\n       FORMAT(SUM(d.debt_value), 2) AS annual_debt\nFROM debt_data d\nWHERE d.country_code = 'CHN'\nGROUP BY d.year\nORDER BY d.year;"}, {"num": 19, "title": "Count of Unique Indicators Used per Country", "sql": "SELECT d.country_code, c.country_name,\n       COUNT(DISTINCT d.indicator_code) AS indicator_count\nFROM debt_data d\nJOIN countries c ON d.country_code = c.country_code\nWHERE c.region IS NOT NULL\nGROUP BY d.country_code, c.country_name\nORDER BY indicator_count DESC\nLIMIT 15;"}, {"num": 20, "title": "Countries with Negative debt_value (Net Outflows)", "sql": "SELECT d.country_code, c.country_name,\n       COUNT(*)                         AS negative_records,\n       FORMAT(SUM(d.debt_value), 2)     AS total_negative\nFROM debt_data d\nJOIN countries c ON d.country_code = c.country_code\nWHERE d.debt_value < 0\n  AND c.region IS NOT NULL\nGROUP BY d.country_code, c.country_name\nORDER BY SUM(d.debt_value) ASC\nLIMIT 10;"}, {"num": 21, "title": "Rank Countries by Total Debt Using RANK()", "sql": "SELECT country_name, total_debt,\n       RANK() OVER (ORDER BY total_debt DESC) AS debt_rank\nFROM (\n    SELECT c.country_name,\n           SUM(d.debt_value) AS total_debt\n    FROM debt_data d\n    JOIN countries c ON d.country_code = c.country_code\n    WHERE c.region IS NOT NULL\n    GROUP BY c.country_name\n) ranked\nORDER BY debt_rank\nLIMIT 15;"}, {"num": 22, "title": "Running Cumulative Global Debt by Year Using SUM() OVER", "sql": "SELECT year, annual_debt,\n       FORMAT(SUM(annual_debt) OVER (ORDER BY year), 2) AS cumulative_debt\nFROM (\n    SELECT d.year, SUM(d.debt_value) AS annual_debt\n    FROM debt_data d\n    JOIN countries c ON d.country_code = c.country_code\n    WHERE c.region IS NOT NULL\n    GROUP BY d.year\n) yearly\nORDER BY year;"}, {"num": 23, "title": "Year-over-Year Global Debt Growth Using LAG()", "sql": "SELECT year, annual_debt,\n       LAG(annual_debt) OVER (ORDER BY year)          AS prev_year_debt,\n       ROUND(\n           (annual_debt - LAG(annual_debt) OVER (ORDER BY year))\n           / LAG(annual_debt) OVER (ORDER BY year) * 100, 2\n       )                                               AS yoy_growth_pct\nFROM (\n    SELECT d.year, SUM(d.debt_value) AS annual_debt\n    FROM debt_data d\n    JOIN countries c ON d.country_code = c.country_code\n    WHERE c.region IS NOT NULL\n    GROUP BY d.year\n) yearly\nORDER BY year;"}, {"num": 24, "title": "Countries Contributing More Than 5% of Global Debt", "sql": "SELECT country_name,\n       FORMAT(total_debt, 2)                                  AS total_debt_usd,\n       ROUND(total_debt * 100.0 / global_total, 2)           AS pct_of_global\nFROM (\n    SELECT c.country_name,\n           SUM(d.debt_value) AS total_debt,\n           (SELECT SUM(d2.debt_value)\n            FROM debt_data d2\n            JOIN countries c2 ON d2.country_code = c2.country_code\n            WHERE c2.region IS NOT NULL) AS global_total\n    FROM debt_data d\n    JOIN countries c ON d.country_code = c.country_code\n    WHERE c.region IS NOT NULL\n    GROUP BY c.country_name\n) t\nWHERE total_debt * 100.0 / global_total > 5\nORDER BY pct_of_global DESC;"}, {"num": 25, "title": "Rank Countries Within Each Region Using PARTITION BY", "sql": "SELECT country_name, region, total_debt,\n       RANK() OVER (PARTITION BY region ORDER BY total_debt DESC) AS rank_in_region\nFROM (\n    SELECT c.country_name, c.region,\n           SUM(d.debt_value) AS total_debt\n    FROM debt_data d\n    JOIN countries c ON d.country_code = c.country_code\n    WHERE c.region IS NOT NULL\n    GROUP BY c.country_name, c.region\n) t\nORDER BY region, rank_in_region\nLIMIT 30;"}, {"num": 26, "title": "3-Year Moving Average of Global Debt", "sql": "SELECT year, annual_debt,\n       ROUND(\n           AVG(annual_debt) OVER (ORDER BY year ROWS BETWEEN 2 PRECEDING AND CURRENT ROW),\n           2\n       ) AS moving_avg_3yr\nFROM (\n    SELECT d.year, SUM(d.debt_value) AS annual_debt\n    FROM debt_data d\n    JOIN countries c ON d.country_code = c.country_code\n    WHERE c.region IS NOT NULL\n    GROUP BY d.year\n) yearly\nORDER BY year;"}, {"num": 27, "title": "Year with Highest Single-Year Debt Growth Rate", "sql": "SELECT year, annual_debt, prev_debt,\n       ROUND((annual_debt - prev_debt) / prev_debt * 100, 2) AS growth_pct\nFROM (\n    SELECT year, annual_debt,\n           LAG(annual_debt) OVER (ORDER BY year) AS prev_debt\n    FROM (\n        SELECT d.year, SUM(d.debt_value) AS annual_debt\n        FROM debt_data d\n        JOIN countries c ON d.country_code = c.country_code\n        WHERE c.region IS NOT NULL\n        GROUP BY d.year\n    ) base\n) with_lag\nWHERE prev_debt IS NOT NULL\nORDER BY growth_pct DESC\nLIMIT 5;"}, {"num": 28, "title": "Countries with Above-Average Debt in Their Income Group", "sql": "SELECT d.country_code, c.country_name, c.income_group,\n       FORMAT(SUM(d.debt_value), 2)  AS country_total,\n       FORMAT(grp.avg_debt, 2)       AS group_average\nFROM debt_data d\nJOIN countries c ON d.country_code = c.country_code\nJOIN (\n    SELECT c2.income_group,\n           AVG(ctry.ctry_total) AS avg_debt\n    FROM (\n        SELECT d2.country_code, SUM(d2.debt_value) AS ctry_total\n        FROM debt_data d2\n        JOIN countries c3 ON d2.country_code = c3.country_code\n        WHERE c3.income_group IS NOT NULL AND c3.region IS NOT NULL\n        GROUP BY d2.country_code\n    ) ctry\n    JOIN countries c2 ON ctry.country_code = c2.country_code\n    GROUP BY c2.income_group\n) grp ON c.income_group = grp.income_group\nWHERE c.income_group IS NOT NULL AND c.region IS NOT NULL\nGROUP BY d.country_code, c.country_name, c.income_group, grp.avg_debt\nHAVING SUM(d.debt_value) > grp.avg_debt\nORDER BY c.income_group, SUM(d.debt_value) DESC\nLIMIT 20;"}, {"num": 29, "title": "Debt Percentile Rank per Country Using PERCENT_RANK()", "sql": "SELECT country_name, total_debt,\n       ROUND(PERCENT_RANK() OVER (ORDER BY total_debt) * 100, 1) AS percentile_rank\nFROM (\n    SELECT c.country_name,\n           SUM(d.debt_value) AS total_debt\n    FROM debt_data d\n    JOIN countries c ON d.country_code = c.country_code\n    WHERE c.region IS NOT NULL\n    GROUP BY c.country_name\n) t\nORDER BY percentile_rank DESC\nLIMIT 20;"}, {"num": 30, "title": "Total Debt by Income Group per Year (Last 5 Years)", "sql": "SELECT d.year, c.income_group,\n       FORMAT(SUM(d.debt_value), 2) AS total_debt\nFROM debt_data d\nJOIN countries c ON d.country_code = c.country_code\nWHERE c.income_group IS NOT NULL\n  AND d.year >= 2020\nGROUP BY d.year, c.income_group\nORDER BY d.year, SUM(d.debt_value) DESC;"}]],
        "Title": [q["title"] for q in [{"num": 1, "title": "Preview debt_data Table", "sql": "SELECT * FROM debt_data LIMIT 10;"}, {"num": 2, "title": "Count Total Records in debt_data", "sql": "SELECT COUNT(*) AS total_records FROM debt_data;"}, {"num": 3, "title": "List All Countries with Region", "sql": "SELECT country_code, country_name, region, income_group\nFROM countries\nWHERE region IS NOT NULL\nORDER BY country_name;"}, {"num": 4, "title": "List All Indicators with Topic", "sql": "SELECT indicator_code, indicator_name, topic\nFROM indicators\nORDER BY topic, indicator_name\nLIMIT 20;"}, {"num": 5, "title": "All Debt Records for India (IND)", "sql": "SELECT d.country_code, c.country_name, i.indicator_name, d.year, d.debt_value\nFROM debt_data d\nJOIN countries  c ON d.country_code   = c.country_code\nJOIN indicators i ON d.indicator_code = i.indicator_code\nWHERE d.country_code = 'IND'\nORDER BY d.year, i.indicator_name\nLIMIT 20;"}, {"num": 6, "title": "All Records for Year 2020", "sql": "SELECT d.country_code, c.country_name, d.indicator_code, d.debt_value\nFROM debt_data d\nJOIN countries c ON d.country_code = c.country_code\nWHERE d.year = 2020\n  AND c.region IS NOT NULL\nORDER BY d.debt_value DESC\nLIMIT 20;"}, {"num": 7, "title": "Records Where debt_value Exceeds 1 Billion", "sql": "SELECT d.country_code, c.country_name, d.indicator_code, d.year, d.debt_value\nFROM debt_data d\nJOIN countries c ON d.country_code = c.country_code\nWHERE d.debt_value > 1000000000\n  AND c.region IS NOT NULL\nORDER BY d.debt_value DESC\nLIMIT 20;"}, {"num": 8, "title": "Count Records per Country", "sql": "SELECT d.country_code, c.country_name, COUNT(*) AS record_count\nFROM debt_data d\nJOIN countries c ON d.country_code = c.country_code\nWHERE c.region IS NOT NULL\nGROUP BY d.country_code, c.country_name\nORDER BY record_count DESC\nLIMIT 15;"}, {"num": 9, "title": "Top 10 Highest Single debt_value Records", "sql": "SELECT d.country_code, c.country_name, i.indicator_name, d.year, d.debt_value\nFROM debt_data d\nJOIN countries  c ON d.country_code   = c.country_code\nJOIN indicators i ON d.indicator_code = i.indicator_code\nWHERE c.region IS NOT NULL\nORDER BY d.debt_value DESC\nLIMIT 10;"}, {"num": 10, "title": "All Countries in South Asia Region", "sql": "SELECT country_code, country_name, income_group, lending_category\nFROM countries\nWHERE region = 'South Asia'\nORDER BY country_name;"}, {"num": 11, "title": "Total Debt per Country (Top 15)", "sql": "SELECT d.country_code, c.country_name,\n       FORMAT(SUM(d.debt_value), 2) AS total_debt_usd\nFROM debt_data d\nJOIN countries c ON d.country_code = c.country_code\nWHERE c.region IS NOT NULL\nGROUP BY d.country_code, c.country_name\nORDER BY SUM(d.debt_value) DESC\nLIMIT 15;"}, {"num": 12, "title": "Total Global Debt per Year", "sql": "SELECT d.year, FORMAT(SUM(d.debt_value), 2) AS global_total_debt\nFROM debt_data d\nJOIN countries c ON d.country_code = c.country_code\nWHERE c.region IS NOT NULL\nGROUP BY d.year\nORDER BY d.year;"}, {"num": 13, "title": "Average and Total Debt by Income Group", "sql": "SELECT c.income_group,\n       COUNT(DISTINCT d.country_code)    AS countries,\n       FORMAT(AVG(d.debt_value), 2)      AS avg_debt,\n       FORMAT(SUM(d.debt_value), 2)      AS total_debt\nFROM debt_data d\nJOIN countries c ON d.country_code = c.country_code\nWHERE c.income_group IS NOT NULL\nGROUP BY c.income_group\nORDER BY SUM(d.debt_value) DESC;"}, {"num": 14, "title": "Total Debt by Region", "sql": "SELECT c.region,\n       COUNT(DISTINCT d.country_code)  AS countries,\n       FORMAT(SUM(d.debt_value), 2)    AS total_debt\nFROM debt_data d\nJOIN countries c ON d.country_code = c.country_code\nWHERE c.region IS NOT NULL\nGROUP BY c.region\nORDER BY SUM(d.debt_value) DESC;"}, {"num": 15, "title": "Countries with Total Debt Above Overall Average", "sql": "SELECT d.country_code, c.country_name,\n       FORMAT(SUM(d.debt_value), 2) AS total_debt\nFROM debt_data d\nJOIN countries c ON d.country_code = c.country_code\nWHERE c.region IS NOT NULL\nGROUP BY d.country_code, c.country_name\nHAVING SUM(d.debt_value) > (\n    SELECT AVG(ctry_sum)\n    FROM (\n        SELECT SUM(d2.debt_value) AS ctry_sum\n        FROM debt_data d2\n        JOIN countries c2 ON d2.country_code = c2.country_code\n        WHERE c2.region IS NOT NULL\n        GROUP BY d2.country_code\n    ) t\n)\nORDER BY SUM(d.debt_value) DESC;"}, {"num": 16, "title": "Top 10 Indicators by Total Debt Value", "sql": "SELECT d.indicator_code,\n       LEFT(i.indicator_name, 55)          AS indicator_name,\n       FORMAT(SUM(d.debt_value), 2)        AS total_debt\nFROM debt_data d\nJOIN indicators i ON d.indicator_code = i.indicator_code\nJOIN countries  c ON d.country_code   = c.country_code\nWHERE c.region IS NOT NULL\nGROUP BY d.indicator_code, i.indicator_name\nORDER BY SUM(d.debt_value) DESC\nLIMIT 10;"}, {"num": 17, "title": "Total Debt by Lending Category", "sql": "SELECT c.lending_category,\n       COUNT(DISTINCT d.country_code)  AS countries,\n       FORMAT(SUM(d.debt_value), 2)    AS total_debt\nFROM debt_data d\nJOIN countries c ON d.country_code = c.country_code\nWHERE c.lending_category IS NOT NULL\nGROUP BY c.lending_category\nORDER BY SUM(d.debt_value) DESC;"}, {"num": 18, "title": "Year-wise Debt Trend for China (CHN)", "sql": "SELECT d.year,\n       FORMAT(SUM(d.debt_value), 2) AS annual_debt\nFROM debt_data d\nWHERE d.country_code = 'CHN'\nGROUP BY d.year\nORDER BY d.year;"}, {"num": 19, "title": "Count of Unique Indicators Used per Country", "sql": "SELECT d.country_code, c.country_name,\n       COUNT(DISTINCT d.indicator_code) AS indicator_count\nFROM debt_data d\nJOIN countries c ON d.country_code = c.country_code\nWHERE c.region IS NOT NULL\nGROUP BY d.country_code, c.country_name\nORDER BY indicator_count DESC\nLIMIT 15;"}, {"num": 20, "title": "Countries with Negative debt_value (Net Outflows)", "sql": "SELECT d.country_code, c.country_name,\n       COUNT(*)                         AS negative_records,\n       FORMAT(SUM(d.debt_value), 2)     AS total_negative\nFROM debt_data d\nJOIN countries c ON d.country_code = c.country_code\nWHERE d.debt_value < 0\n  AND c.region IS NOT NULL\nGROUP BY d.country_code, c.country_name\nORDER BY SUM(d.debt_value) ASC\nLIMIT 10;"}, {"num": 21, "title": "Rank Countries by Total Debt Using RANK()", "sql": "SELECT country_name, total_debt,\n       RANK() OVER (ORDER BY total_debt DESC) AS debt_rank\nFROM (\n    SELECT c.country_name,\n           SUM(d.debt_value) AS total_debt\n    FROM debt_data d\n    JOIN countries c ON d.country_code = c.country_code\n    WHERE c.region IS NOT NULL\n    GROUP BY c.country_name\n) ranked\nORDER BY debt_rank\nLIMIT 15;"}, {"num": 22, "title": "Running Cumulative Global Debt by Year Using SUM() OVER", "sql": "SELECT year, annual_debt,\n       FORMAT(SUM(annual_debt) OVER (ORDER BY year), 2) AS cumulative_debt\nFROM (\n    SELECT d.year, SUM(d.debt_value) AS annual_debt\n    FROM debt_data d\n    JOIN countries c ON d.country_code = c.country_code\n    WHERE c.region IS NOT NULL\n    GROUP BY d.year\n) yearly\nORDER BY year;"}, {"num": 23, "title": "Year-over-Year Global Debt Growth Using LAG()", "sql": "SELECT year, annual_debt,\n       LAG(annual_debt) OVER (ORDER BY year)          AS prev_year_debt,\n       ROUND(\n           (annual_debt - LAG(annual_debt) OVER (ORDER BY year))\n           / LAG(annual_debt) OVER (ORDER BY year) * 100, 2\n       )                                               AS yoy_growth_pct\nFROM (\n    SELECT d.year, SUM(d.debt_value) AS annual_debt\n    FROM debt_data d\n    JOIN countries c ON d.country_code = c.country_code\n    WHERE c.region IS NOT NULL\n    GROUP BY d.year\n) yearly\nORDER BY year;"}, {"num": 24, "title": "Countries Contributing More Than 5% of Global Debt", "sql": "SELECT country_name,\n       FORMAT(total_debt, 2)                                  AS total_debt_usd,\n       ROUND(total_debt * 100.0 / global_total, 2)           AS pct_of_global\nFROM (\n    SELECT c.country_name,\n           SUM(d.debt_value) AS total_debt,\n           (SELECT SUM(d2.debt_value)\n            FROM debt_data d2\n            JOIN countries c2 ON d2.country_code = c2.country_code\n            WHERE c2.region IS NOT NULL) AS global_total\n    FROM debt_data d\n    JOIN countries c ON d.country_code = c.country_code\n    WHERE c.region IS NOT NULL\n    GROUP BY c.country_name\n) t\nWHERE total_debt * 100.0 / global_total > 5\nORDER BY pct_of_global DESC;"}, {"num": 25, "title": "Rank Countries Within Each Region Using PARTITION BY", "sql": "SELECT country_name, region, total_debt,\n       RANK() OVER (PARTITION BY region ORDER BY total_debt DESC) AS rank_in_region\nFROM (\n    SELECT c.country_name, c.region,\n           SUM(d.debt_value) AS total_debt\n    FROM debt_data d\n    JOIN countries c ON d.country_code = c.country_code\n    WHERE c.region IS NOT NULL\n    GROUP BY c.country_name, c.region\n) t\nORDER BY region, rank_in_region\nLIMIT 30;"}, {"num": 26, "title": "3-Year Moving Average of Global Debt", "sql": "SELECT year, annual_debt,\n       ROUND(\n           AVG(annual_debt) OVER (ORDER BY year ROWS BETWEEN 2 PRECEDING AND CURRENT ROW),\n           2\n       ) AS moving_avg_3yr\nFROM (\n    SELECT d.year, SUM(d.debt_value) AS annual_debt\n    FROM debt_data d\n    JOIN countries c ON d.country_code = c.country_code\n    WHERE c.region IS NOT NULL\n    GROUP BY d.year\n) yearly\nORDER BY year;"}, {"num": 27, "title": "Year with Highest Single-Year Debt Growth Rate", "sql": "SELECT year, annual_debt, prev_debt,\n       ROUND((annual_debt - prev_debt) / prev_debt * 100, 2) AS growth_pct\nFROM (\n    SELECT year, annual_debt,\n           LAG(annual_debt) OVER (ORDER BY year) AS prev_debt\n    FROM (\n        SELECT d.year, SUM(d.debt_value) AS annual_debt\n        FROM debt_data d\n        JOIN countries c ON d.country_code = c.country_code\n        WHERE c.region IS NOT NULL\n        GROUP BY d.year\n    ) base\n) with_lag\nWHERE prev_debt IS NOT NULL\nORDER BY growth_pct DESC\nLIMIT 5;"}, {"num": 28, "title": "Countries with Above-Average Debt in Their Income Group", "sql": "SELECT d.country_code, c.country_name, c.income_group,\n       FORMAT(SUM(d.debt_value), 2)  AS country_total,\n       FORMAT(grp.avg_debt, 2)       AS group_average\nFROM debt_data d\nJOIN countries c ON d.country_code = c.country_code\nJOIN (\n    SELECT c2.income_group,\n           AVG(ctry.ctry_total) AS avg_debt\n    FROM (\n        SELECT d2.country_code, SUM(d2.debt_value) AS ctry_total\n        FROM debt_data d2\n        JOIN countries c3 ON d2.country_code = c3.country_code\n        WHERE c3.income_group IS NOT NULL AND c3.region IS NOT NULL\n        GROUP BY d2.country_code\n    ) ctry\n    JOIN countries c2 ON ctry.country_code = c2.country_code\n    GROUP BY c2.income_group\n) grp ON c.income_group = grp.income_group\nWHERE c.income_group IS NOT NULL AND c.region IS NOT NULL\nGROUP BY d.country_code, c.country_name, c.income_group, grp.avg_debt\nHAVING SUM(d.debt_value) > grp.avg_debt\nORDER BY c.income_group, SUM(d.debt_value) DESC\nLIMIT 20;"}, {"num": 29, "title": "Debt Percentile Rank per Country Using PERCENT_RANK()", "sql": "SELECT country_name, total_debt,\n       ROUND(PERCENT_RANK() OVER (ORDER BY total_debt) * 100, 1) AS percentile_rank\nFROM (\n    SELECT c.country_name,\n           SUM(d.debt_value) AS total_debt\n    FROM debt_data d\n    JOIN countries c ON d.country_code = c.country_code\n    WHERE c.region IS NOT NULL\n    GROUP BY c.country_name\n) t\nORDER BY percentile_rank DESC\nLIMIT 20;"}, {"num": 30, "title": "Total Debt by Income Group per Year (Last 5 Years)", "sql": "SELECT d.year, c.income_group,\n       FORMAT(SUM(d.debt_value), 2) AS total_debt\nFROM debt_data d\nJOIN countries c ON d.country_code = c.country_code\nWHERE c.income_group IS NOT NULL\n  AND d.year >= 2020\nGROUP BY d.year, c.income_group\nORDER BY d.year, SUM(d.debt_value) DESC;"}]]
    }
    st.dataframe(pd.DataFrame(ref_data), use_container_width=True, height=400, hide_index=True)
...
st.markdown(
    ...
    "Data Source: [World Bank IDS](https://databank.worldbank.org/source/international-debt-statistics) · "
